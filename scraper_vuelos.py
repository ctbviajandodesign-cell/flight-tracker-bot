...
async def extrar_mejor_precio(page, origen, destino, fecha_inicio, fecha_fin, dias_paquete=None):
    ...
    try:
        # TIMEOUT DE CARGA: 30 segundos máximo para abrir la página
        ...
        try:
            ...
            print(f"  ⚠️ Calendario no abierto para {destino}, intentando extraer igual...")
...
async def procesar_una_ruta(browser, r, semaphore):
    async with semaphore:
        ...
        # TIEMPO LÍMITE TOTAL POR RUTA: 90 segundos
        try:
...
async def procesar_rutas():
    ...
    semaphore = asyncio.Semaphore(3)  # Bajamos a 3 para mayor estabilidad
